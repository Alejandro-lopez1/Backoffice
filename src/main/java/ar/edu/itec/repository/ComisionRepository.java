...
public class ComisionRepository {
    ...
    private void cargarComisionesIniciales(MateriaRepository materiaRepository, ProfesorRepository profesorRepository) {
        ...
        // Crear cuatrimestres
        Cuatrimestre c2026_1 = new Cuatrimestre(2026, 1, LocalDate.of(2026, 3, 1), LocalDate.of(2026, 7, 15));
        Cuatrimestre c2026_2 = new Cuatrimestre(2026, 2, LocalDate.of(2026, 8, 1), LocalDate.of(2026, 12, 15));

        // Comisión 1: Programación I - Turno Mañana
        ComisionMateria com1A = new ComisionMateria("Comisión-1", prog1, garcia, c2026_1);
        ...
        ComisionMateria com1B = new ComisionMateria("Comisión-2", prog1, fernandez, c2026_1);
        ...
        ComisionMateria com2A = new ComisionMateria("Comisión-3", prog2, lopez, c2026_2);
        ...
        ComisionMateria com3A = new ComisionMateria("Comisión-4", bd, garcia, c2026_2);
